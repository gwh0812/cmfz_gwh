...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/UserController/login" method="post" >
				...
				<table>
					<tbody>
					  ...
					  <tr>
							...
							<td>
								<input type="password" name="password" class="text" value="password" maxlength="20" autocomplete="off"/>
							</td>
					  </tr>
